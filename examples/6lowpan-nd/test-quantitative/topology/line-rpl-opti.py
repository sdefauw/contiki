...
outputfolder = 'topology/line-rpl-opti'
...
multi_br=0
script_file = "[CONFIG_DIR]/../rpl_opti_script.js"

mote_types = []

mote_type_6lbr = {	'shortname':'6lbr-rpl', 
			'fw_folder':'[CONTIKI_DIR]/examples/6lowpan-nd/6lbr-rpl-opti/', 
...
mote_type_6lr = {	'shortname':'6lr-rpl', 
			'fw_folder':'[CONTIKI_DIR]/examples/6lowpan-nd/6lr-rpl-opti/', 
...
mote_type_6lh = {	'shortname':'6lh', 
			'fw_folder':'[CONTIKI_DIR]/examples/6lowpan-nd/6lh-opti/', 
